...
(function (angular) {
    ...
    angular.module('smartTable.directives', ['smartTable.templateUrlList', 'smartTable.templates', 'smartTable.server', 'ui.bootstrap'])
                ...
                link: function (scope, element, attr, ctrl) {
                    ...
                    scope.$watch('config', function (config) {
                        ...
                        if (newConfig.actions.edit.url) {
                            ...
                            //if(newConfig.actions.add.url)
                            //angular.extend(newColumn, { headerTemplate: '<edit-dialog type="add"></edit-dialog>', headerTemplateUrl: ''});
                        }
        ...
        .directive('confirmDialog', ['$modal', 'templateUrlList', 'smartTableServerSource', function ($modal, templateList, serverSource) {
            return {
                restrict: 'E',
                    ...
                    scope.delUser = function () {
                        ...
                        */
                        var modalInstance = $modal.open({
                            templateUrl: templateList.dialogMessage,
                        ...
                        modalInstance.result.then(handleResult, function () {
                            //$log.info('Modal dismissed at: ' + new Date());
                        });
                    };

                    messageDialogCtrl.$inject = ['$scope', '$modalInstance', 'title', 'message'];
                    function messageDialogCtrl($scope, $modalInstance, title, message) {
                        $scope.title = title;
        ...
        .directive('editDialog', ['$modal', 'templateUrlList', 'smartTableServerSource', function ($modal, templateList, serverSource) {
            return {
                restrict: 'E',
                //include smart table controller to use its API if needed
                require: '^smartTable',
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    scope.pop = function () {
                        ...
                        */
                        var modalInstance = $modal.open({
                            templateUrl: templateList.dialogEdit,
                        ...
                        modalInstance.result.then(handleAction, function () {
                            //$log.info('Modal dismissed at: ' + new Date());
                        });
                    ...
                    editDialogCtrl.$inject = ['$scope', '$modalInstance', 'dataRow', 'columns', 'type', 'title', 'url'];
                    function editDialogCtrl($scope, $modalInstance, dataRow, columns, type, title, url) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    scope.$watch('isEditMode', function (newValue, oldValue) {
                        if (newValue === true) { // TODO: check needed
                            input[0].select();
                            input[0].focus();
                        }
                    });
...
angular.module("partials/smartTable.html", []).run(["$templateCache", function ($templateCache) {
    ...
    "        <td class=\"smart-table-global-search {{globalSearchClass}}\" global-search-class=\"{{config.globalSearchClass}}\" colspan=\"{{columns.length}}\">\n" +
    "        </td>\n" +
    "    </tr>\n" +
    "    <tr class=\"smart-table-global-search-row\" ng-show=\"isGlobalSearchActivated\">\n" +
...
angular.module("partials/dialogMessage.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("partials/dialogMessage.html",
      "<div class=\"modal-header\">\n" +
      "	<h3>{{ title }}</h3>\n" +
      "</div>\n" +
      "<div class=\"modal-body\">\n" +
      ...
      "<div class=\"modal-footer\">\n" +
      "    <button ng-click=\"close()\" class=\"btn btn-danger\">Close</button>\n" +
      "    <button ng-click=\"del()\" class=\"btn btn-success\" ng-disabled=\"smartTableValidForm.$invalid\">Delete</button>\n" +
      "</div>\n" +
      "");
}]);
...
(function (angular) {
    ...
    angular.module('smartTable.templateUrlList', [])
        .constant('templateUrlList', {
            ...
            dialogMessage: 'partials/dialogMessage.html'
        });
})(angular);
